...
The basic approach is as follows :-
    ...
    Traverse the linked list to the given elements a and b
    Set the next of a to the head of the other given linked list
    Set the next of the tail of the other given linked list to the pointer to b
    Return the original linked list as the final answer
